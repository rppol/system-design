...
> See [Observability: Metrics with Prometheus](../../devops/observability_metrics_prometheus/observability_metrics_prometheus.md), [Observability: Logging](../../devops/observability_logging/observability_logging.md), and [Observability: Tracing & OTel](../../devops/observability_tracing_and_otel/observability_tracing_and_otel.md) for the full operational deep-dives — PromQL, Loki LogQL, OTel Collector pipeline configuration, and Grafana dashboard design.
...
**Cross-references:** [Observability: Metrics with Prometheus](../../devops/observability_metrics_prometheus/observability_metrics_prometheus.md) (PromQL, recording rules, Prometheus federation), [Observability: Logging](../../devops/observability_logging/observability_logging.md) (Loki/ELK architecture, log pipeline design), [Observability: Tracing & OTel](../../devops/observability_tracing_and_otel/observability_tracing_and_otel.md) (OpenTelemetry Collector configuration, exporter pipelines), [Spring Observability & Tracing](../../spring/observability_and_tracing/observability_and_tracing.md) (Micrometer Observation API, Spring Boot Actuator integration), [Backend Observability & Monitoring](../../backend/observability_and_monitoring/observability_and_monitoring.md) (MDC, structured logging in Java, SLO implementation), [Microservices](../microservices/microservices.md) (§6.3 Distributed Tracing — where this module's tracing concepts are applied across service boundaries).
