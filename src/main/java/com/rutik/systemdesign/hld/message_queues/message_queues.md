...
**Cross-references:** [backend/kafka_deep_dive](../../backend/kafka_deep_dive/kafka_deep_dive.md) (partitions, consumer groups, ISR, exactly-once semantics), [backend/messaging_patterns](../../backend/messaging_patterns/messaging_patterns.md) (competing consumers, pub/sub, saga via messaging), [backend/event_driven_fundamentals](../../backend/event_driven_fundamentals/event_driven_fundamentals.md), [spring/spring_messaging](../../spring/spring_messaging/spring_messaging.md) (`@KafkaListener`, JMS, RabbitMQ templates), [devops/event_streaming_operations](../../devops/event_streaming_operations/event_streaming_operations.md) (running and operating Kafka clusters), [fastapi/message_queues_and_event_driven](../../fastapi/message_queues_and_event_driven/message_queues_and_event_driven.md) (Celery and FastAPI background processing).
