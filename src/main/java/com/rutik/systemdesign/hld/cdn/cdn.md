...
**Cross-references:** [devops/cloud_networking_and_cdn](../../devops/cloud_networking_and_cdn/cloud_networking_and_cdn.md) (CloudFront/Fastly configuration, origin shield, Anycast routing).
