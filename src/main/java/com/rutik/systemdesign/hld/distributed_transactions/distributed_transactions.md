...
> This module covers Saga at the decision level (§8, §9) only. The full mechanics — event store, choreography vs. orchestration code, and a worked compensating-transaction example — live in [Event Sourcing & CQRS](../event_sourcing_cqrs/event_sourcing_cqrs.md) (§4 "Saga: Choreography vs Orchestration") and [Microservices](../microservices/microservices.md) (§6.2).
...
| Local transaction frameworks | Spring `@Transactional` (see [Spring Transactions](../../spring/spring_transactions/spring_transactions.md)) | The "local transaction" half of every pattern in this module |
...
**Cross-references:** [Microservices](../microservices/microservices.md) (§4.4 Data Management, §6.2 Saga summary — where this module's patterns are applied across service boundaries), [Event Sourcing & CQRS](../event_sourcing_cqrs/event_sourcing_cqrs.md) (full Saga choreography/orchestration deep-dive with code), [Distributed Transactions and Consistency](../../backend/distributed_transactions_and_consistency/distributed_transactions_and_consistency.md) (production implementation: XA drivers, Kafka transactional producers, Spring `@Transactional` boundaries), [Distributed Transactions](../../database/distributed_transactions/distributed_transactions.md) (database-internals view: how Spanner/CockroachDB implement 2PC with a global clock), [Spring Transactions](../../spring/spring_transactions/spring_transactions.md) (local transaction propagation that underlies every saga step), [Messaging Patterns](../../backend/messaging_patterns/messaging_patterns.md) (outbox, inbox, DLQ, schema evolution in depth).
