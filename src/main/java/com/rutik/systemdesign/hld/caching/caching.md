...
**Cross-references:** [backend/caching_strategies_deep_dive](../../backend/caching_strategies_deep_dive/caching_strategies_deep_dive.md) (cache stampede protection, multi-tier caching, write-behind implementation), [database/database_caching_patterns](../../database/database_caching_patterns/database_caching_patterns.md) (DB-level caching and materialized views), [database/in_memory_databases](../../database/in_memory_databases/in_memory_databases.md) (Redis/Memcached internals), [spring/spring_caching](../../spring/spring_caching/spring_caching.md) (`@Cacheable`/`@CacheEvict` and Spring's cache abstraction), [llm/llm_caching](../../llm/llm_caching/llm_caching.md) (KV-cache and prompt caching for LLM inference).
