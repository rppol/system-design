...
| Message queue | Kafka (`listing_updates` topic) | §3, §4.6 — cross-ref [`../message_queues/message_queues.md`](../message_queues/message_queues.md) |
| Attributes cache (long TTL) | Redis / Memcached, TTL hours | §4.5 — cross-ref [`../caching/caching.md`](../caching/caching.md) |
...
- **Elasticsearch `geo_point` and inverted-index internals for Phase 2 (§4.2, §5, §6)** -> [`../../database/search_engines/search_engines.md`](../../database/search_engines/search_engines.md)
- **Split-TTL caching strategy for the Attributes vs. Status caches (§4.5, §9 War Story 2)** -> [`../caching/caching.md`](../caching/caching.md)
- **Cache-aside and read-through patterns underlying the two-tier cache (§4.5, §8)** -> [`../../database/database_caching_patterns/database_caching_patterns.md`](../../database/database_caching_patterns/database_caching_patterns.md)
- **Outbox pattern and CDC propagation for the write path (§4.6, §5)** -> [`../distributed_transactions/distributed_transactions.md`](../distributed_transactions/distributed_transactions.md)
- **A/B test bucketing and consistent-hashing-based experiment assignment (§11)** -> [`../consistent_hashing/consistent_hashing.md`](../consistent_hashing/consistent_hashing.md)
- **Graceful degradation during a search-cluster outage (§11)** -> [`../resilience_patterns/resilience_patterns.md`](../resilience_patterns/resilience_patterns.md)
