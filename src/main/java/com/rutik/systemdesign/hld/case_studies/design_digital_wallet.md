...
| Shard routing | Consistent hashing on `wallet_id` (cross-ref [`../consistent_hashing/consistent_hashing.md`](../consistent_hashing/consistent_hashing.md)) | Determines which shard a given wallet (and most P2P transfers) lands on, §10 |
...
| Encryption at rest for PII (SSN, bank account numbers) | HSM-backed KMS (cross-ref [`../security_and_auth/security_and_auth.md`](../security_and_auth/security_and_auth.md)) | KYC data and linked bank account numbers are highly sensitive |
...
- **Saga and outbox patterns underlying top-up, withdrawal, and cross-shard transfers (§4.4, §5)** -> [`../distributed_transactions/distributed_transactions.md`](../distributed_transactions/distributed_transactions.md)
- **ACID guarantees for ledger writes and cross-shard consistency at scale (§4.1, §5, §10)** -> [`../../database/distributed_transactions/distributed_transactions.md`](../../database/distributed_transactions/distributed_transactions.md)
- **Consistent hashing for wallet shard placement and rebalancing (§5, §10)** -> [`../consistent_hashing/consistent_hashing.md`](../consistent_hashing/consistent_hashing.md)
- **Sharding and partitioning strategy for the wallet ledger fleet (§10)** -> [`../../database/sharding_and_partitioning/sharding_and_partitioning.md`](../../database/sharding_and_partitioning/sharding_and_partitioning.md)
- **KYC, encryption at rest for PII (SSN, bank account numbers), and secrets management (§4.6, §7)** -> [`../security_and_auth/security_and_auth.md`](../security_and_auth/security_and_auth.md)
- **Reconciliation, drift alerting, and SLI/SLO framing for the operational playbook (§8)** -> [`../observability/observability.md`](../observability/observability.md)
- **Event-driven propagation of wallet-credited/debited events via outbox/Kafka (§3, §4.4)** -> [`../event_sourcing_cqrs/event_sourcing_cqrs.md`](../event_sourcing_cqrs/event_sourcing_cqrs.md)
