...
- [hld/case_studies/ — the repo's worked designs (Twitter, WhatsApp, URL shortener, web crawler, notifications, autocomplete, Netflix, Google Drive)](../../../hld/case_studies/case_studies.md)

Sibling SDI-1 chapters whose primitives this chapter synthesizes:

- [Ch 1 — Scale From Zero to Millions (the toolbox every design reuses)](../01_scale_from_zero_to_millions_of_users/01_scale_from_zero_to_millions_of_users.md)
- [Ch 5 — Consistent Hashing (the most-reused primitive)](../05_design_consistent_hashing/05_design_consistent_hashing.md)
- [Ch 8 — URL Shortener (canonical read-heavy design)](../08_design_a_url_shortener/08_design_a_url_shortener.md)
- [Ch 9 — Web Crawler (DAG-pipeline design)](../09_design_a_web_crawler/09_design_a_web_crawler.md)
- [Ch 10 — Notification System (fan-out + push)](../10_design_a_notification_system/10_design_a_notification_system.md)
- [Ch 12 — Chat System (WebSocket + fan-out)](../12_design_a_chat_system/12_design_a_chat_system.md)
