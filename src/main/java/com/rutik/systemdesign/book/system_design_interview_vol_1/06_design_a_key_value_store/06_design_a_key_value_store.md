...
- [hld/cap_theorem/ — CAP definitions, PACELC, CP/AP deep dive](../../../hld/cap_theorem/cap_theorem.md)
- [database/consistency_models_and_consensus/ — quorums, vector clocks, gossip, consensus](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
- [database/storage_engines_internals/ — LSM-tree, commit log, memtable, SSTable, bloom filters](../../../database/storage_engines_internals/storage_engines_internals.md)
- [book/DDIA Ch 5 — Replication (leaderless, quorums, read repair, vector clocks in depth)](../../designing_data_intensive_applications/05_replication/05_replication.md)
- [book/DDIA Ch 3 — Storage and Retrieval (LSM-trees vs B-trees, SSTables, bloom filters)](../../designing_data_intensive_applications/03_storage_and_retrieval/03_storage_and_retrieval.md)
- [SDI-1 Ch 5 — Design Consistent Hashing (the ring, virtual nodes, rebalancing this chapter reuses)](../05_design_consistent_hashing/05_design_consistent_hashing.md)
