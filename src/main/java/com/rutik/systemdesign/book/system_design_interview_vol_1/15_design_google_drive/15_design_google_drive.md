...
- [book Ch 12 — Design a Chat System (long polling vs WebSocket, the opposite choice)](../12_design_a_chat_system/12_design_a_chat_system.md)
- [book Ch 14 — Design YouTube (blob storage, resumable uploads, pre-signed URLs)](../14_design_youtube/14_design_youtube.md)
- [database/consistency_models_and_consensus/ — strong vs eventual consistency, ACID, cache-DB consistency](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
