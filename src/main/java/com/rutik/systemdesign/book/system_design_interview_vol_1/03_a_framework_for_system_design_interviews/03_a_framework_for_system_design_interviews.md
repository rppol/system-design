...
- [Ch 4 · Design a Rate Limiter — the first chapter that applies this 4-step framework end-to-end](../04_design_a_rate_limiter/04_design_a_rate_limiter.md)
- [Ch 2 · Back-of-the-Envelope Estimation — the sizing habit Step 1 and Step 2 lean on](../02_back_of_the_envelope_estimation/02_back_of_the_envelope_estimation.md)
- [Ch 1 · Scale From Zero to Millions — the toolbox you draw the Step-2 blueprint from](../01_scale_from_zero_to_millions_of_users/01_scale_from_zero_to_millions_of_users.md)
- [ml/ml_interview_patterns/ — the ML-system-design counterpart to this framework](../../../ml/ml_interview_patterns/ml_interview_patterns.md)
- [cs_fundamentals/dsa_patterns/ — the coding-round counterpart: a pattern-recognition framework for the algorithm interview](../../../cs_fundamentals/dsa_patterns/dsa_patterns.md)
