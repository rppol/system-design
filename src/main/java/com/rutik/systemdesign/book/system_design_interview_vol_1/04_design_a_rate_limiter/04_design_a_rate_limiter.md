...
- [hld/rate_limiting/ — the standalone rate-limiting deep dive (algorithms, distributed counters, Redis)](../../../hld/rate_limiting/rate_limiting.md)
- [hld/caching/ — Redis as an in-memory counter store, expiration, and cache patterns](../../../hld/caching/caching.md)
- [backend/ — API gateway, middleware placement, resilience, and 429 handling](../../../backend/CLAUDE.md)
- [Ch 5 — Design Consistent Hashing (the next building-block chapter; sharding limiter state)](../05_design_consistent_hashing/05_design_consistent_hashing.md)
- [DDIA Ch 5 — Replication (why cross-DC limiter state is eventually consistent)](../../designing_data_intensive_applications/05_replication/05_replication.md)
