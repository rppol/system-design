...
- [hld/caching/ — cache strategies, hot keys, cache-aside, and eviction behind the five cache layers](../../../hld/caching/caching.md)
- [hld/message_queues/ — decoupling the fanout path with a queue and worker pool](../../../hld/message_queues/message_queues.md)
- [Ch 10 — Design a Notification System (the notification service that alerts friends)](../10_design_a_notification_system/10_design_a_notification_system.md)
- [Ch 12 — Design a Chat System (the sibling real-time delivery problem)](../12_design_a_chat_system/12_design_a_chat_system.md)
