...
- [hld/caching/ — cache-aside, TTL, eviction, Redis vs Memcached for the redirect hot path](../../../hld/caching/caching.md)
- [hld/rate_limiting/ — token bucket / sliding window backing the Step-4 rate limiter](../../../hld/rate_limiting/rate_limiting.md)
- [book Ch 7 — Design A Unique ID Generator (feeds Approach B's base-62 encoder)](../07_design_a_unique_id_generator/07_design_a_unique_id_generator.md)
- [book Ch 4 — Design A Rate Limiter (guards the shorten write path)](../04_design_a_rate_limiter/04_design_a_rate_limiter.md)
