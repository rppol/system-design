...
[ml/multi_task_and_multi_objective_learning](../../../ml/multi_task_and_multi_objective_learning/multi_task_and_multi_objective_learning.md).
...
- **Point-in-time correctness** — every feature must reflect state *as of the impression*, or the
  ...
  [ml/feature_engineering](../../../ml/feature_engineering/feature_engineering.md).
...
- **Ethics of engagement ranking** — pure engagement optimization can amplify outrage, misinfo, and
  ...
  [fairness and responsible AI](../../../ml/fairness_and_responsible_ai/fairness_and_responsible_ai.md).
...
- [ml/multi_task_and_multi_objective_learning](../../../ml/multi_task_and_multi_objective_learning/multi_task_and_multi_objective_learning.md) — shared-bottom multi-task nets, per-task loss balancing, positive/negative transfer.
...
- [ml/feature_engineering](../../../ml/feature_engineering/feature_engineering.md) — embeddings, bucketization, batch vs streaming features, point-in-time correctness.
...
- [ml/fairness_and_responsible_ai](../../../ml/fairness_and_responsible_ai/fairness_and_responsible_ai.md) — the ethics of engagement optimization, rabbit holes, guardrails.
...
- [SDI-1 Ch 11: Design a News Feed System](../../system_design_interview_vol_1/11_design_a_news_feed_system/11_design_a_news_feed_system.md) — the fanout/storage/feed-plumbing side (write vs read fanout) that this ML chapter sits on top of.
