...
- [Part III: Scalability — the caches, queues, and services these patterns defend](../03_scalability/03_scalability.md)
- [Part V: Maintainability — the SLOs and observability that make resilience visible](../05_maintainability/05_maintainability.md)
- [hld/resilience_patterns/ — timeouts, retries, circuit breakers, bulkheads at a glance](../../../hld/resilience_patterns/resilience_patterns.md)
- [hld/rate_limiting/ — token bucket, sliding window, distributed rate limiting](../../../hld/rate_limiting/rate_limiting.md)
- [backend/fault_tolerance_patterns/ — circuit breaker, bulkhead, retry, fallback implementations](../../../backend/fault_tolerance_patterns/fault_tolerance_patterns.md)
- [backend/rate_limiting_in_depth/ — algorithms, distributed counters, atomic increments](../../../backend/rate_limiting_in_depth/rate_limiting_in_depth.md)
- [backend/chaos_engineering/ — deliberately injecting the failures this chapter catalogs](../../../backend/chaos_engineering/chaos_engineering.md)
- [devops/disaster_recovery_and_resilience/ — redundancy, AZ/region failover, RPO/RTO](../../../devops/disaster_recovery_and_resilience/disaster_recovery_and_resilience.md)
- [book/SDI Vol 1 Ch 4 — Design a Rate Limiter (the upstream-resiliency §4.5 pattern, end to end)](../../system_design_interview_vol_1/04_design_a_rate_limiter/04_design_a_rate_limiter.md)
- [book/DDIA Ch 8 — The Trouble with Distributed Systems (network faults, gray failures, unreliable clocks)](../../designing_data_intensive_applications/08_trouble_with_distributed_systems/08_trouble_with_distributed_systems.md)
