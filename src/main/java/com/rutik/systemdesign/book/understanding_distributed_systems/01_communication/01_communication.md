...
- [backend/tcp_ip_deep_dive/ — TCP internals, handshake, TIME_WAIT, congestion control in depth](../../../backend/tcp_ip_deep_dive/tcp_ip_deep_dive.md)
- [backend/udp_and_quic/ — UDP, QUIC, and HTTP/3 mechanics](../../../backend/udp_and_quic/udp_and_quic.md)
- [backend/http_protocols/ — HTTP/1.1 vs 2 vs 3, keep-alive, multiplexing, HOL blocking](../../../backend/http_protocols/http_protocols.md)
- [backend/rest_api_design/ — REST resources, methods, versioning, idempotency keys](../../../backend/rest_api_design/rest_api_design.md)
- [hld/api_design/ — API design at system-design scope](../../../hld/api_design/api_design.md)
