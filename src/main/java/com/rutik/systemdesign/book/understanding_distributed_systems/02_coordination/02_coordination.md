...
[DDIA Chapter 7](../../designing_data_intensive_applications/07_transactions/07_transactions.md) treatment is
...
- [Part I: Communication — the links and protocols these algorithms run over](../01_communication/01_communication.md)
- [Part III: Scalability — what these coordination primitives cost at scale](../03_scalability/03_scalability.md)
- [database/consistency_models_and_consensus/ — linearizability, Raft/Paxos, quorums, deeper](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
- [hld/consensus_algorithms/ — Raft/Paxos election and log replication in depth](../../../hld/consensus_algorithms/consensus_algorithms.md)
- [hld/cap_theorem/ — CAP and PACELC, CP vs AP system design](../../../hld/cap_theorem/cap_theorem.md)
- [database/distributed_transactions/ — 2PC, sagas, outbox, Spanner across partitions](../../../database/distributed_transactions/distributed_transactions.md)
- [backend/distributed_transactions_and_consistency/ — outbox, saga orchestration, idempotency](../../../backend/distributed_transactions_and_consistency/distributed_transactions_and_consistency.md)
- [database/concurrency_control_and_locking/ — MVCC, 2PL, SSI, deadlocks, write skew](../../../database/concurrency_control_and_locking/concurrency_control_and_locking.md)
- DDIA deeper treatments (summarized here, not duplicated):
  - [DDIA Ch 5 — Replication (leaders, quorums, conflict resolution)](../../designing_data_intensive_applications/05_replication/05_replication.md)
  - [DDIA Ch 7 — Transactions (isolation levels, write skew, serializability)](../../designing_data_intensive_applications/07_transactions/07_transactions.md)
  - [DDIA Ch 8 — The Trouble with Distributed Systems (clocks, failures, truth)](../../designing_data_intensive_applications/08_trouble_with_distributed_systems/08_trouble_with_distributed_systems.md)
  - [DDIA Ch 9 — Consistency and Consensus (linearizability, total order, 2PC)](../../designing_data_intensive_applications/09_consistency_and_consensus/09_consistency_and_consensus.md)
