...
- [Part II: Coordination — the consistency machinery under every store scaled here](../02_coordination/02_coordination.md)
- [Part IV: Resiliency — keeping all of this alive under partial failure](../04_resiliency/04_resiliency.md)
- [hld/caching/ — cache patterns, eviction, invalidation, stampede protection](../../../hld/caching/caching.md)
- [hld/cdn/ — CDN architecture, edge caching, pull vs push, dynamic acceleration](../../../hld/cdn/cdn.md)
- [hld/consistent_hashing/ — the ring, virtual nodes, mod-N reshuffle, Dynamo-style placement](../../../hld/consistent_hashing/consistent_hashing.md)
- [hld/load_balancing/ — L4 vs L7, health checks, routing algorithms, DNS steering](../../../hld/load_balancing/load_balancing.md)
- [hld/message_queues/ — brokers, delivery guarantees, DLQs, backlog handling](../../../hld/message_queues/message_queues.md)
- [backend/kafka_deep_dive/ — partitions, offsets, consumer groups, exactly-once processing](../../../backend/kafka_deep_dive/kafka_deep_dive.md)
- [database/sharding_and_partitioning/ — range vs hash sharding, rebalancing, scatter-gather](../../../database/sharding_and_partitioning/sharding_and_partitioning.md)
- [backend/caching_strategies_deep_dive/ — cache-aside vs write-through, local vs external, load-bearing caches](../../../backend/caching_strategies_deep_dive/caching_strategies_deep_dive.md)

Related inline (see also): [hld/microservices/](../../../hld/microservices/microservices.md),
[backend/api_gateway_patterns/](../../../backend/api_gateway_patterns/api_gateway_patterns.md),
[DDIA Ch 6 — Partitioning](../../designing_data_intensive_applications/06_partitioning/06_partitioning.md),
[SDI Vol 1 Ch 5 — Design Consistent Hashing](../../system_design_interview_vol_1/05_design_consistent_hashing/05_design_consistent_hashing.md),
[SDI Vol 1 Ch 6 — Design a Key-Value Store](../../system_design_interview_vol_1/06_design_a_key_value_store/06_design_a_key_value_store.md),
[SDI Vol 2 Ch 4 — Distributed Message Queue](../../system_design_interview_vol_2/04_distributed_message_queue/04_distributed_message_queue.md),
[SDI Vol 2 Ch 9 — S3-like Object Storage](../../system_design_interview_vol_2/09_s3_like_object_storage/09_s3_like_object_storage.md).
