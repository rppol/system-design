...
- [database/storage_engines_internals/ — LSM-trees, SSTables, compaction (RocksDB-style mapping table)](../../../database/storage_engines_internals/storage_engines_internals.md)
- [database/consistency_models_and_consensus/ — Paxos/Raft, quorum, eventual consistency (placement service, listing table)](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
- [DDIA Ch 3 — Storage and Retrieval: append-only logs, LSM-trees, compaction](../../designing_data_intensive_applications/03_storage_and_retrieval/03_storage_and_retrieval.md)
- [DDIA Ch 5 — Replication: leader/follower, quorum, failure handling](../../designing_data_intensive_applications/05_replication/05_replication.md)
- [DDIA Ch 6 — Partitioning: hash-based sharding, scatter-gather, secondary-index scatter](../../designing_data_intensive_applications/06_partitioning/06_partitioning.md)
- [SDI Vol 1 Ch 15 — Design Google Drive: file storage, chunking, dedup, metadata split](../../system_design_interview_vol_1/15_design_google_drive/15_design_google_drive.md)
- [SDI Vol 1 Ch 6 — Design a Key-Value Store: consistent hashing, quorum, replication placement](../../system_design_interview_vol_1/06_design_a_key_value_store/06_design_a_key_value_store.md)
