...
- [hld/distributed_transactions/ — 2PC, Saga, idempotency across services](../../../hld/distributed_transactions/distributed_transactions.md)
- [hld/resilience_patterns/ — retries, backoff, DLQ, circuit breakers](../../../hld/resilience_patterns/resilience_patterns.md)
- [book — DDIA Ch 7 Transactions — atomicity, idempotency, and the exactly-once problem](../../designing_data_intensive_applications/07_transactions/07_transactions.md)
- [Vol 2 Ch 7 — Hotel Reservation System — idempotency and double-booking prevention this chapter builds on](../07_hotel_reservation_system/07_hotel_reservation_system.md)
- [Vol 2 Ch 12 — Digital Wallet — generalizes the wallet/balance and ledger concepts](../12_digital_wallet/12_digital_wallet.md)
