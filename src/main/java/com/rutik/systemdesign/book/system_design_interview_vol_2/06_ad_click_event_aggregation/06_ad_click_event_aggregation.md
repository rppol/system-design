...
- [book/SDI Vol 2 Ch 4 — Distributed Message Queue (the Kafka-style log this pipeline sits on)](../04_distributed_message_queue/04_distributed_message_queue.md)
- [book/DDIA Ch 11 — Stream Processing (event time, windows, exactly-once, Lambda vs Kappa at book depth)](../../designing_data_intensive_applications/11_stream_processing/11_stream_processing.md)
- [ml/data_pipelines_and_processing — batch vs stream, windowing, and pipeline design for ML features](../../../ml/data_pipelines_and_processing/data_pipelines_and_processing.md)
