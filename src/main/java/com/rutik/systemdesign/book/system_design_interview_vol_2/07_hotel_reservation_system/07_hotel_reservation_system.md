...
- [database/concurrency_control_and_locking — MVCC, `SELECT FOR UPDATE`, deadlocks, optimistic vs pessimistic](../../../database/concurrency_control_and_locking/concurrency_control_and_locking.md)
- [hld/distributed_transactions — 2PC and saga / compensating transactions in depth](../../../hld/distributed_transactions/distributed_transactions.md)
- [book/DDIA Ch 7 Transactions — lost update, write skew, and the isolation levels behind these fixes](../../designing_data_intensive_applications/07_transactions/07_transactions.md)
- [Sibling: Ch 11 Payment System — expands the saga / charge-and-refund flow this chapter only touches](../11_payment_system/11_payment_system.md)
