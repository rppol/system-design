...
- [book/.../05_replication/ — the replication log that CDC consumes](../05_replication/05_replication.md)
- [database/distributed_transactions/ — the outbox pattern, an alternative to dual writes](../../../database/distributed_transactions/distributed_transactions.md)
