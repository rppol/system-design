...
- [database/consistency_models_and_consensus/ — fencing tokens, leader election, quorums](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
- [database/replication_and_high_availability/ — split-brain, failover detection in practice](../../../database/replication_and_high_availability/replication_and_high_availability.md)
- [java/concurrency/ — JVM stop-the-world GC pauses (a real process-pause source)](../../../java/concurrency/concurrency.md)
