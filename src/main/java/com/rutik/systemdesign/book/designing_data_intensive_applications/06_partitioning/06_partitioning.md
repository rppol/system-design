...
- [database/sharding_and_partitioning/ — consistent hashing, shard-key selection, Vitess, resharding](../../../database/sharding_and_partitioning/sharding_and_partitioning.md)
- [database/replication_and_high_availability/ — how partitions are also replicated](../../../database/replication_and_high_availability/replication_and_high_availability.md)
- [database/wide_column_databases/ — Cassandra partition keys, compound keys, vnodes](../../../database/wide_column_databases/wide_column_databases.md)
