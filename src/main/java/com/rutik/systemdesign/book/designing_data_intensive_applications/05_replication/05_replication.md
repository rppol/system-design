...
- [database/replication_and_high_availability/ — Patroni, split-brain, replication slots, multi-region](../../../database/replication_and_high_availability/replication_and_high_availability.md)
- [database/consistency_models_and_consensus/ — version clocks, CRDTs, fencing tokens](../../../database/consistency_models_and_consensus/consistency_models_and_consensus.md)
- [database/wide_column_databases/ — Cassandra ring, consistency levels, tombstones](../../../database/wide_column_databases/wide_column_databases.md)
