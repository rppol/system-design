...
- [database/concurrency_control_and_locking/ — MVCC, deadlocks, gap locks, SELECT FOR UPDATE](../../../database/concurrency_control_and_locking/concurrency_control_and_locking.md)
- [database/database_fundamentals/ — ACID, isolation levels, anomalies overview](../../../database/database_fundamentals/database_fundamentals.md)
- [database/postgresql_internals/ — MVCC, VACUUM, serializable (SSI) in PostgreSQL](../../../database/postgresql_internals/postgresql_internals.md)
- [database/distributed_transactions/ — extending transactions across partitions (2PC, Saga)](../../../database/distributed_transactions/distributed_transactions.md)
