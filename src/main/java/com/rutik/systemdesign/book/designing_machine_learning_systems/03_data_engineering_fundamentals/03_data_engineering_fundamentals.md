...
- [ml/data_pipelines_and_processing/ — batch vs stream pipelines, feature stores, ETL/ELT in ML](../../../ml/data_pipelines_and_processing/data_pipelines_and_processing.md)
- [database/storage_engines_internals/ — row vs column stores, LSM/B-tree, on-disk layout](../../../database/storage_engines_internals/storage_engines_internals.md)
- [DDIA Ch 2 — Data Models and Query Languages (relational vs document vs graph, declarative SQL)](../../designing_data_intensive_applications/02_data_models_and_query_languages/02_data_models_and_query_languages.md)
- [DDIA Ch 3 — Storage and Retrieval (row vs column stores, OLTP vs OLAP engines)](../../designing_data_intensive_applications/03_storage_and_retrieval/03_storage_and_retrieval.md)
- [DDIA Ch 10 — Batch Processing (MapReduce, Spark, bounded data)](../../designing_data_intensive_applications/10_batch_processing/10_batch_processing.md)
- [DDIA Ch 11 — Stream Processing (unbounded data, brokers, stateful streaming)](../../designing_data_intensive_applications/11_stream_processing/11_stream_processing.md)
- [SDI Vol 2 Ch 4 — Distributed Message Queue (pub/sub vs queue, retention, brokers)](../../system_design_interview_vol_2/04_distributed_message_queue/04_distributed_message_queue.md)
