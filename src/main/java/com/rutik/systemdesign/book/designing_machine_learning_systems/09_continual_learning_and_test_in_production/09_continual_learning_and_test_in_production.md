...
- [ml/mlops_and_ci_cd/ — automated retraining pipelines, model registry, CI/CD for models (Stages 2–4 infra)](../../../ml/mlops_and_ci_cd/mlops_and_ci_cd.md)
- [ml/monitoring_and_drift_detection/ — drift detectors that fire Stage-4 update triggers](../../../ml/monitoring_and_drift_detection/monitoring_and_drift_detection.md)
- [ml/recommender_systems/ — collaborative filtering (why matrix models resist incremental updates) and interleaving](../../../ml/recommender_systems/recommender_systems.md)
- [ml/reinforcement_learning/ — multi-armed and contextual bandits, explore-exploit, Thompson sampling / UCB](../../../ml/reinforcement_learning/reinforcement_learning.md)
- [DMLS Ch 8 — Data Distribution Shifts and Monitoring (the decay this chapter cures)](../08_data_distribution_shifts_and_monitoring/08_data_distribution_shifts_and_monitoring.md)
- [DMLS Ch 10 — Infrastructure and Tooling for MLOps (schedulers, feature stores, model stores)](../10_infrastructure_and_tooling_for_mlops/10_infrastructure_and_tooling_for_mlops.md)
- [DDIA Ch 11 — Stream Processing (windowed joins behind log-and-wait label computation)](../../designing_data_intensive_applications/11_stream_processing/11_stream_processing.md)
