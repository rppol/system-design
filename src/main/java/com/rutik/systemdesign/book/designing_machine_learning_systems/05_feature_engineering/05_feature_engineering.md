...
- [ml/feature_engineering/ — the repo's deep dive on feature operations, encoding, and stores](../../../ml/feature_engineering/feature_engineering.md)
- [ml/imbalanced_data_and_leakage_traps/ — leakage causes, group splits, and class imbalance](../../../ml/imbalanced_data_and_leakage_traps/imbalanced_data_and_leakage_traps.md)
- [ml/interpretability_and_explainability/ — SHAP, feature importance, and per-prediction attribution](../../../ml/interpretability_and_explainability/interpretability_and_explainability.md)
- [Ch 4: Training Data — sampling, labeling, class imbalance (this chapter's predecessor)](../04_training_data/04_training_data.md)
- [Ch 10: Infrastructure and Tooling for MLOps — feature stores that serve engineered features](../10_infrastructure_and_tooling_for_mlops/10_infrastructure_and_tooling_for_mlops.md)
