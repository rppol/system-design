...
- [ml/active_learning_and_weak_supervision/ — Snorkel labeling functions, uncertainty sampling, semi-supervision in depth](../../../ml/active_learning_and_weak_supervision/active_learning_and_weak_supervision.md)
- [ml/imbalanced_data_and_leakage_traps/ — resampling, SMOTE, focal loss, and the leakage traps that inflate imbalanced metrics](../../../ml/imbalanced_data_and_leakage_traps/imbalanced_data_and_leakage_traps.md)
- [ml/supervised_learning/ — the supervised-learning setting these labels feed](../../../ml/supervised_learning/supervised_learning.md)
- [ml/model_evaluation_and_selection/ — precision/recall/F1, PR vs ROC, threshold selection](../../../ml/model_evaluation_and_selection/model_evaluation_and_selection.md)
- [Ch 5: Feature Engineering — turning this training data into model features (and data leakage)](../05_feature_engineering/05_feature_engineering.md)
