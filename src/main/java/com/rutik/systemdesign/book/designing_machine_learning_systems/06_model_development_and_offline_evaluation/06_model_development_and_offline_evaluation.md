...
- [ml/model_evaluation_and_selection/ — offline eval, baselines, slice-based evaluation, calibration](../../../ml/model_evaluation_and_selection/model_evaluation_and_selection.md)
- [ml/model_selection_and_algorithm_choice/ — the six selection tips, assumptions, tradeoffs](../../../ml/model_selection_and_algorithm_choice/model_selection_and_algorithm_choice.md)
- [ml/ensemble_methods/ — bagging, boosting, stacking, random forests, gradient boosting](../../../ml/ensemble_methods/ensemble_methods.md)
- [ml/distributed_training/ — data/model/pipeline parallelism, sync vs async SGD](../../../ml/distributed_training/distributed_training.md)
- [ml/experiment_tracking_and_versioning/ — MLflow/W&B, DVC, reproducibility](../../../ml/experiment_tracking_and_versioning/experiment_tracking_and_versioning.md)
- [ml/uncertainty_quantification_and_conformal_prediction/ — calibration, confidence, Platt scaling](../../../ml/uncertainty_quantification_and_conformal_prediction/uncertainty_quantification_and_conformal_prediction.md)
- Sibling chapters: [Ch 5 — Feature Engineering](../05_feature_engineering/05_feature_engineering.md) (the features this chapter's models consume) · [Ch 7 — Model Deployment and Prediction Service](../07_model_deployment_and_prediction_service/07_model_deployment_and_prediction_service.md) (online evaluation, batch vs online, model compression)
- DDIA parallel: [DDIA Ch 7 — Transactions](../../designing_data_intensive_applications/07_transactions/07_transactions.md) (the reproducibility/determinism and versioning discipline mirrors data-consistency guarantees)
