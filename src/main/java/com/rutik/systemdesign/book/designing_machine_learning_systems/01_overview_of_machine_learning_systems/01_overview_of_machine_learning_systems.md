...
- [Ch 2: Introduction to ML Systems Design — the design process this overview motivates](../02_introduction_to_machine_learning_systems_design/02_introduction_to_machine_learning_systems_design.md)
- [ml/ — the repository's Machine Learning guide (overview and index)](../../../ml/README.md)
- [ml/ml_system_design/ — designing end-to-end ML systems (the system around the model)](../../../ml/ml_system_design/ml_system_design.md)
- [ml/ml_interview_patterns/ — ML system-design interview patterns (framing, stakeholders, metrics)](../../../ml/ml_interview_patterns/ml_interview_patterns.md)
- [ml/model_serving_and_inference/ — inference latency, batching, percentiles, edge serving](../../../ml/model_serving_and_inference/model_serving_and_inference.md)
- [ml/monitoring_and_drift_detection/ — data distribution shift and monitoring (Ch 8 preview)](../../../ml/monitoring_and_drift_detection/monitoring_and_drift_detection.md)
- [ml/fairness_and_responsible_ai/ — bias at scale, fairness metrics, responsible ML](../../../ml/fairness_and_responsible_ai/fairness_and_responsible_ai.md)
- [ml/interpretability_and_explainability/ — explainability, trust, and regulation](../../../ml/interpretability_and_explainability/interpretability_and_explainability.md)
- [book/DDIA Ch 8 — the trouble with distributed systems (the messy-reality analogue for data)](../../designing_data_intensive_applications/08_trouble_with_distributed_systems/08_trouble_with_distributed_systems.md)
