...
- [ml/ml_system_design/ — the full ML-system-design workflow (requirements, framing, metrics) expanded](../../../ml/ml_system_design/ml_system_design.md)
- [ml/model_evaluation_and_selection/ — ML metrics (accuracy, F1, RMSE, log loss) and how to choose them](../../../ml/model_evaluation_and_selection/model_evaluation_and_selection.md)
- [ml/case_studies/ — worked ML system designs applying this framing end-to-end](../../../ml/case_studies/case_studies.md)
- [Ch 1 — Overview of Machine Learning Systems (when to use ML, research vs production)](../01_overview_of_machine_learning_systems/01_overview_of_machine_learning_systems.md)
- [Ch 9 — Continual Learning and Test in Production (the adaptability requirement, realized)](../09_continual_learning_and_test_in_production/09_continual_learning_and_test_in_production.md)
