...
**What is the God Object antipattern and how do you identify one?**
...
**What is the Anemic Domain Model antipattern, and why is it harmful?**
...
**How does Service Locator differ from Dependency Injection, and why is Service Locator considered worse?**
...
**How do you handle Lava Flow code that nobody dares to touch?**
...
**What causes circular dependencies and how do you break them?**
...
**How does Copy-Paste programming compound over time?**
...
**Golden Hammer: give a real-world engineering example and the fix.**
