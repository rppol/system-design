...
5. **"How does Factory Method differ from a simple static factory method (Effective Java Item 1)?"**
...
7. **"How does Factory Method support the Open/Closed Principle in practice — walk through adding a new product type?"**
