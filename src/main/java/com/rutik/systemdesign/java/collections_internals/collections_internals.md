...
- [Java Memory Model](../java_memory_model/java_memory_model.md) — safe publication of collection contents, `volatile` reference semantics
- [Generics & Type System](../generics_and_type_system/generics_and_type_system.md) — bounded type parameters and PECS in generic collection APIs
- [Case Study: LRU Cache](../case_studies/design_lru_cache_java.md) — LinkedHashMap + lock pattern for a production-grade LRU cache
- [Arrays, Strings & Hashing](../../cs_fundamentals/arrays_strings_and_hashing/arrays_strings_and_hashing.md) — hash table fundamentals and collision strategies underlying `HashMap`
- [Trees & Binary Search Trees](../../cs_fundamentals/trees_and_binary_search_trees/trees_and_binary_search_trees.md) — red-black tree mechanics behind HashMap's treeified buckets
