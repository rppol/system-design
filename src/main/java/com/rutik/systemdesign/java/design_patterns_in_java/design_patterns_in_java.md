...
<!-- study-paths
senior: design_patterns_in_java.md
principal: design_patterns_in_java.md
...
[LLD: Concurrency Patterns](../../lld/concurrency_patterns/concurrency_patterns.md); the primitives behind
them are in [Concurrency](../concurrency/concurrency.md).
...
- [Java Interview Patterns](../java_interview_patterns/java_interview_patterns.md) — interview-focused subset: immutable class, Builder, enum singleton, factory method
