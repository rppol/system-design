...
<!-- study-paths
principal: microservices_patterns.md
...
[structured_concurrency_and_loom](../structured_concurrency_and_loom/structured_concurrency_and_loom.md)).
...
- [structured_concurrency_and_loom](../structured_concurrency_and_loom/structured_concurrency_and_loom.md) —
  ...
  orchestration calls.
- [concurrency](../concurrency/concurrency.md) — `CompletableFuture`,
...
- [Event Sourcing & CQRS](../../backend/event_sourcing_and_cqrs/event_sourcing_and_cqrs.md) —
  event sourcing as the durable foundation behind sagas and outboxes.
- [Microservices (HLD)](../../hld/microservices/microservices.md) — the architecture-level
  view of service decomposition and communication this module implements in code.
- [Distributed Transactions (HLD)](../../hld/distributed_transactions/distributed_transactions.md) —
