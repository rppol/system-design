...
<!-- study-paths
senior: java_interview_patterns.md
...
- [Core Language](../core_language/core_language.md) — OOP fundamentals, equals/hashCode contract, polymorphism
- [Concurrency](../concurrency/concurrency.md) — thread-safe singleton, DCL with volatile
- [Design Patterns in Java](../design_patterns_in_java/design_patterns_in_java.md) — full GoF pattern catalog beyond interview focus patterns
