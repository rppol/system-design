...
GPU-centric serving stacks. Where [NVIDIA Triton](../nvidia_triton_inference_server/nvidia_triton_inference_server.md)
and [vLLM](../../llm/vllm_deep_dive/vllm_deep_dive.md) assume a CUDA GPU, OpenVINO's default
...
- Your estate is **NVIDIA-GPU training/serving** — OpenVINO has no CUDA device; use
  [Triton](../nvidia_triton_inference_server/nvidia_triton_inference_server.md) / [vLLM](../../llm/vllm_deep_dive/vllm_deep_dive.md).
- You need **massive-scale LLM serving** with paged attention and high concurrency —
  that's [vLLM](../../llm/vllm_deep_dive/vllm_deep_dive.md) / SGLang territory on GPUs.
...
and [`cuda/tensor_cores_and_mixed_precision`](../../cuda/tensor_cores_and_mixed_precision/tensor_cores_and_mixed_precision.md).
...
story](../nvidia_triton_inference_server/nvidia_triton_inference_server.md#14-case-study--consolidating-12-single-model-services-onto-a-shared-triton-fleet):
...
- [`nvidia_triton_inference_server`](../nvidia_triton_inference_server/nvidia_triton_inference_server.md) — the
  GPU-serving counterpart; hosts OpenVINO via its OpenVINO backend.
- [`apache_airflow`](../apache_airflow/apache_airflow.md) — the other Technologies deep dive.
- [`llm/inference_engines`](../../llm/inference_engines/inference_engines.md) and
  [`llm/vllm_deep_dive`](../../llm/vllm_deep_dive/vllm_deep_dive.md) — GPU-side LLM serving,
  contrasted with OpenVINO's CPU/edge LLM path.
- [`llm/optimization_and_quantization`](../../llm/optimization_and_quantization/optimization_and_quantization.md)
