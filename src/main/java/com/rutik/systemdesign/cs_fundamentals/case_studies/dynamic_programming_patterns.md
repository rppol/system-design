...
*Cross-references: [dynamic_programming module](../dynamic_programming/dynamic_programming.md) — full 14-section treatment with all DP families; [recursion_and_problem_solving_patterns](../recursion_and_problem_solving_patterns/recursion_and_problem_solving_patterns.md) — recursion fundamentals and the recursion-to-DP derivation pattern; [complexity_analysis_and_big_o](../complexity_analysis_and_big_o/complexity_analysis_and_big_o.md) — pseudo-polynomial vs polynomial; [graph_traversal_and_shortest_path case study](./graph_traversal_and_shortest_path.md) — Dijkstra as a greedy/DP hybrid.*
