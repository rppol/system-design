...
<!-- study-paths
senior: heaps_and_priority_queues.md
...
- [Java Collections Internals](../../java/collections_internals/collections_internals.md) — `PriorityQueue` internals, `PriorityBlockingQueue`, `Comparator` with PQ
- [Sorting and Searching](../sorting_and_searching/sorting_and_searching.md) — heapsort as a comparison sort; O(n log n) guarantee
- [Graph and String Algorithms](../graph_and_string_algorithms/graph_and_string_algorithms.md) — Dijkstra and Prim using heaps
- [Python Collections and Data Structures](../../python/collections_and_data_structures/collections_and_data_structures.md) — `heapq`, `sortedcontainers`
- [HLD Caching Patterns](../../hld/README.md) — LRU/LFU eviction uses heap + hashmap
- [DSA Pattern Playbooks](../dsa_patterns/dsa_patterns.md) — apply these structures: [Top K Elements](../dsa_patterns/top_k_elements.md), [K-Way Merge](../dsa_patterns/k_way_merge.md), [Two Heaps](../dsa_patterns/two_heaps.md)
