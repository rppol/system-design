...
- [computer_architecture_and_memory_hierarchy](../computer_architecture_and_memory_hierarchy/computer_architecture_and_memory_hierarchy.md) — latency numbers at every level of the memory hierarchy; context for why network RTT dominates
- [cryptography_fundamentals](../cryptography_fundamentals/cryptography_fundamentals.md) — TLS underlying cryptography: symmetric encryption, ECDHE, certificates, and hash functions
- [../../backend/osi_model_and_networking](../../backend/osi_model_and_networking/osi_model_and_networking.md) — full 7-layer OSI deep dive with protocol headers, Ethernet frames, and ARP
- [../../backend/tcp_ip_deep_dive](../../backend/tcp_ip_deep_dive/tcp_ip_deep_dive.md) — TCP header fields, sequence numbers, SACK, congestion control internals (CUBIC, BBR)
- [../../backend/udp_and_quic](../../backend/udp_and_quic/udp_and_quic.md) — QUIC protocol, HTTP/3, QUIC streams and flow control
- [../../backend/http_protocols](../../backend/http_protocols/http_protocols.md) — HTTP/1.1 pipelining, HTTP/2 frames and streams, HTTP/3 over QUIC
