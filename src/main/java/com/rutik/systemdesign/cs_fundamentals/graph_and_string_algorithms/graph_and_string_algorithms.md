...
<!-- study-paths
senior: graph_and_string_algorithms.md
...
The data structure foundations (adjacency list/matrix, Trie, Union-Find, segment tree) are covered in [`graphs_tries_and_advanced_structures`](../graphs_tries_and_advanced_structures/graphs_tries_and_advanced_structures.md).
...
- [graphs_tries_and_advanced_structures](../graphs_tries_and_advanced_structures/graphs_tries_and_advanced_structures.md) — graph representations, Trie, Union-Find (Kruskal's data structure), Bloom filter
- [heaps_and_priority_queues](../heaps_and_priority_queues/heaps_and_priority_queues.md) — Dijkstra's min-heap, Prim's MST
- [sorting_and_searching](../sorting_and_searching/sorting_and_searching.md) — Kruskal edge sort, binary search in string algorithms
- [greedy_and_divide_and_conquer](../greedy_and_divide_and_conquer/greedy_and_divide_and_conquer.md) — Dijkstra as greedy, Kruskal/Prim as greedy MST, Huffman
- [`backend/osi_model_and_networking`](../../backend/osi_model_and_networking/osi_model_and_networking.md) — OSPF uses Dijkstra; BGP uses Bellman-Ford
- [`devops/linux_and_os_fundamentals`](../../devops/linux_and_os_fundamentals/linux_and_os_fundamentals.md) — Linux CFS scheduler (conceptually a priority queue + scheduling policy)
- [DSA Pattern Playbooks](../dsa_patterns/dsa_patterns.md) — apply these algorithms: [Graph Traversal (BFS/DFS)](../dsa_patterns/graph_traversal.md), [Topological Sort](../dsa_patterns/topological_sort.md), [Union-Find](../dsa_patterns/union_find.md), [Shortest Path](../dsa_patterns/shortest_path.md)
