...
- Applied: [`../../hld/rate_limiting/rate_limiting.md`](../../hld/rate_limiting/rate_limiting.md) — the *sliding window counter* and *sliding window log* rate-limiting algorithms are this exact pattern applied to time-based windows in production systems
