...
- [arrays_strings_and_hashing](../arrays_strings_and_hashing/arrays_strings_and_hashing.md) — hash table internals; amortized O(1) in practice
- [sorting_and_searching](../sorting_and_searching/sorting_and_searching.md) — Θ(n log n) lower bound proof; comparison of sorting algorithms
- [heaps_and_priority_queues](../heaps_and_priority_queues/heaps_and_priority_queues.md) — O(n) heapify proof in detail
- [`java/collections_internals`](../../java/collections_internals/collections_internals.md) — per-collection Big-O tables for HashMap, TreeMap, ArrayList, PriorityQueue
- [`database/indexing_deep_dive`](../../database/indexing_deep_dive/indexing_deep_dive.md) — O(log n) B+Tree lookup in production
- [DSA Pattern Playbooks](../dsa_patterns/dsa_patterns.md) — the constraints -> complexity -> pattern inference table (master README §3) turns this module's asymptotic analysis into a "what algorithm fits this n?" decision tool
