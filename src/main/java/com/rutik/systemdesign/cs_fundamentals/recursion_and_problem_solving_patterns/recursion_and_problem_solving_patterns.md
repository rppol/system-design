...
- [dynamic_programming](../dynamic_programming/dynamic_programming.md) — memoised recursion = DP; overlapping subproblems
- [graph_and_string_algorithms](../graph_and_string_algorithms/graph_and_string_algorithms.md) — DFS is recursive by nature; backtracking in graphs
- [sorting_and_searching](../sorting_and_searching/sorting_and_searching.md) — binary search as divide-and-conquer; merge sort recursion
- [complexity_analysis_and_big_o](../complexity_analysis_and_big_o/complexity_analysis_and_big_o.md) — Master Theorem for recursive time complexity
- [DSA Pattern Playbooks](../dsa_patterns/dsa_patterns.md) — apply this technique: [Backtracking](../dsa_patterns/backtracking.md) (subsets, permutations, combinations, constraint search — N-Queens, Sudoku)
