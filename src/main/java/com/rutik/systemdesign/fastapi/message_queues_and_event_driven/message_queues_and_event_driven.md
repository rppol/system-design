...
Cross-links:
- [Background Jobs and Task Queues](../background_jobs_and_task_queues/background_jobs_and_task_queues.md)
- [HLD Message Queue Patterns](../../hld/case_studies/case_studies.md)
