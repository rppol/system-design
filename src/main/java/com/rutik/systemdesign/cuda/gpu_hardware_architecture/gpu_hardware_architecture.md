...
<!-- study-paths
senior: gpu_hardware_architecture.md
...
[gpu_computing_foundations](../gpu_computing_foundations/gpu_computing_foundations.md) and is the hardware
prerequisite for the full memory model covered in
[cuda_memory_model_and_hierarchy](../cuda_memory_model_and_hierarchy/cuda_memory_model_and_hierarchy.md).
...
[cuda_toolkit_and_compilation](../cuda_toolkit_and_compilation/cuda_toolkit_and_compilation.md) for the full pipeline.
...
[cuda_memory_model_and_hierarchy](../cuda_memory_model_and_hierarchy/cuda_memory_model_and_hierarchy.md)) exists to keep
...
- **NVIDIA H100 (Hopper, SXM5)**: 132 SMs, 80 GB HBM3 at ~3.35 TB/s, 50 MB L2, 228 KB
  ...
  [`../../ml/gpu_and_hardware_optimization/`](../../ml/gpu_and_hardware_optimization/gpu_and_hardware_optimization.md)
...
5. **Assuming Tensor Cores engage automatically for any matmul-shaped kernel.** Tensor
   ...
   [tensor_cores_and_mixed_precision](../tensor_cores_and_mixed_precision/tensor_cores_and_mixed_precision.md) for exactly
...
| Nsight Compute | Per-kernel *achieved* occupancy, register/thread usage, spill traffic, SM throughput | Ground truth vs the theoretical §6 math — see [profiling_and_performance_analysis](../profiling_and_performance_analysis/profiling_and_performance_analysis.md) |
...
**See also**: [gpu_computing_foundations](../gpu_computing_foundations/gpu_computing_foundations.md) for the
throughput-vs-latency and SIMT-vs-SIMD framing this module assumes;
[cuda_memory_model_and_hierarchy](../cuda_memory_model_and_hierarchy/cuda_memory_model_and_hierarchy.md) for the full
global/shared/local/constant/register memory model built on top of the hardware
described here; [tensor_cores_and_mixed_precision](../tensor_cores_and_mixed_precision/tensor_cores_and_mixed_precision.md)
for the Tensor Core programming model this module only introduces; and
[`../../ml/gpu_and_hardware_optimization/`](../../ml/gpu_and_hardware_optimization/gpu_and_hardware_optimization.md) for
