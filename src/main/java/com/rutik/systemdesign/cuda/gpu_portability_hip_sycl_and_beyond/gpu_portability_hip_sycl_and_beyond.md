...
| oneAPI plugins for NVIDIA and AMD | SYCL-for-CUDA, SYCL-for-HIP backends for NVIDIA and AMD GPUs, built by Codeplay (an Intel subsidiary) | Let a single SYCL source target NVIDIA/AMD hardware, not only Intel |
