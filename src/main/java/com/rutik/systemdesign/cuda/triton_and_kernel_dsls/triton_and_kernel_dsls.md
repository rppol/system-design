...
- **Thread-level explicit DSL embedded in a host language (Numba CUDA, PyCUDA)**
  ...
  See [python_gpu_ecosystem](../python_gpu_ecosystem/python_gpu_ecosystem.md) for Numba's full API.
...
- **Template metaprogramming (CUTLASS)** — C++ templates instantiate GEMM/conv
  ...
  layer. See [cuda_math_and_dnn_libraries](../cuda_math_and_dnn_libraries/cuda_math_and_dnn_libraries.md).
...
[shared_memory_and_bank_conflicts](../shared_memory_and_bank_conflicts/shared_memory_and_bank_conflicts.md)); the
...
- **vLLM and SGLang custom kernels** — both inference engines ship Triton
  ...
  See [`llm/inference_engines`](../../llm/inference_engines/inference_engines.md) and
  [`llm/vllm_deep_dive`](../../llm/vllm_deep_dive/vllm_deep_dive.md).
