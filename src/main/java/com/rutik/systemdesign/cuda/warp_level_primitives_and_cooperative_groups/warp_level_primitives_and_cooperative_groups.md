...
- **Histogram and stream-compaction kernels** use warp-aggregated atomics (§6.5) to avoid
  ...
  [synchronization_and_atomics](../synchronization_and_atomics/synchronization_and_atomics.md) — Thrust's
...
See also: [warps_and_simt_execution](../warps_and_simt_execution/warps_and_simt_execution.md) for the divergence and
active-mask mechanics this module builds on;
[synchronization_and_atomics](../synchronization_and_atomics/synchronization_and_atomics.md) for the plain-atomic
