...
- [Spring Batch](../spring_batch/spring_batch.md) — event-driven batch triggers
- [Spring Events & Scheduling](../spring_events_and_scheduling/spring_events_and_scheduling.md) — @TransactionalEventListener
- [Case Study: Event-Driven Microservice](../case_studies/design_event_driven_microservice.md) — Kafka integration
- [Kafka Deep Dive](../../backend/kafka_deep_dive/kafka_deep_dive.md) — Kafka internals, EOS, Schema Registry
- [Message Queues (HLD)](../../hld/message_queues/message_queues.md) — broker architecture at the system-design level
- [Event-Driven Fundamentals](../../backend/event_driven_fundamentals/event_driven_fundamentals.md) — choreography vs orchestration
