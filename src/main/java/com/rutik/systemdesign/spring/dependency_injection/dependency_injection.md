...
<!-- study-paths
senior: dependency_injection.md
...
- [IoC Container](../ioc_container/ioc_container.md) — ApplicationContext and bean registration
- [Spring Configuration](../spring_configuration/spring_configuration.md) — @Bean methods
- [Spring Boot Auto-Configuration](../spring_boot_autoconfiguration/spring_boot_autoconfiguration.md) — auto-wiring
- [Case Study: DI Container (Java)](../../java/case_studies/design_di_container_java.md) — reflection-based IoC
- [LLD: SOLID Principles](../../lld/solid_principles/solid_principles.md) — the Dependency Inversion Principle DI frameworks exist to satisfy
- [LLD: Dependency Inversion Principle](../../lld/solid_principles/DependencyInversion.md) — deep dive on the specific principle
- [LLD: Factory Method Pattern](../../lld/creational/factory_method/factory_method.md) — `BeanFactory` is a Factory Method at framework scale
