...
- [Spring Security Architecture](../spring_security_architecture/spring_security_architecture.md) — FilterChainProxy
...
- [Auth & Authorization Systems](../../backend/auth_and_authorization_systems/auth_and_authorization_systems.md) — OAuth2/OIDC flows and token revocation at the systems level
- [Security & Auth (HLD)](../../hld/security_and_auth/security_and_auth.md) — authn/authz tradeoffs in distributed system design
