...
- [Request Handling](../request_handling/request_handling.md) — @ControllerAdvice
- [Spring Security Architecture](../spring_security_architecture/spring_security_architecture.md) — security filter chain
- [Case Study: Rate Limiter](../case_studies/design_distributed_rate_limiter_spring.md) — OncePerRequestFilter
- [LLD: Chain of Responsibility](../../lld/behavioral/chain_of_responsibility/chain_of_responsibility.md) — the GoF pattern the Spring filter chain implements
