...
- [IoC Container](../ioc_container/ioc_container.md) — BeanFactory context and container bootstrap
- [Spring Proxies](../spring_proxies/spring_proxies.md) — BeanPostProcessor creates proxies
- [Spring AOP](../spring_aop/spring_aop.md) — AOP lifecycle hooks
- [LLD: Singleton Pattern](../../lld/creational/singleton/singleton.md) — the GoF pattern behind Spring's default singleton bean scope
