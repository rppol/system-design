...
**Why can a distilled student hallucinate more than its teacher, and how do you prevent it?**
...
**What is DARE, and why can you randomly drop 90% of a task vector without losing the skill?**
...
**What are model soups, and when does averaging checkpoints from the same task help?**
