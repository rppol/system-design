...
**What is the "textbooks are all you need" insight from Microsoft's Phi models, and why does it matter?**
...
**How does knowledge distillation differ from fine-tuning for improving a small model?**
...
**Explain the tradeoff between Q4_K_M and Q8_0 GGUF quantization. When would you choose each?**
...
**How do you decide whether to run inference on-device versus sending a request to a cloud LLM?**
...
**What is the memory footprint of a 3B parameter model at INT4 quantization, and what does this mean for minimum device requirements?**
...
**How does the Apple Neural Engine differ from a CPU for LLM inference, and what are the constraints?**
...
**What are the thermal and power constraints that affect sustained SLM inference on mobile devices?**
...
**How would you architect a hybrid on-device/cloud inference system for a mobile app?**
...
**What privacy guarantees does on-device inference actually provide, and what are the limits?**
...
**How do you evaluate whether a quantized SLM is suitable for your production task before deployment?**
...
**What is the role of Grouped Query Attention (GQA) in making SLMs viable for edge deployment?**
