...
- **Single simple tool, one model.** If you are building one function that one model calls, native function calling (OpenAI function calling, Anthropic tool use) is simpler. The protocol overhead of MCP is unjustified.
