...
<!-- study-paths
senior: README.md, mcp_server_building.md, mcp_transports_and_jsonrpc.md, mcp_security.md
principal: README.md, mcp_security.md, mcp_registries_and_ecosystem.md
