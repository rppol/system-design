...
- **[Tool calls](../agents_and_tool_use/agents_and_tool_use.md) during audio**: agent may need to look up info mid-conversation; UX requires "thinking" filler.
