...
## See Also
- [Data Pipelines & Processing (ML)](../../ml/data_pipelines_and_processing/data_pipelines_and_processing.md) — PySpark, Great Expectations, schema evolution — the data engineering behind LLM pre-training datasets
- [Training Infrastructure](../training_infrastructure/training_infrastructure.md) — ZeRO/FSDP, tensor and pipeline parallelism, checkpointing at cluster scale
- [Fine-Tuning](../fine_tuning/fine_tuning.md) — the 100-1000× cheaper alternative when you do not need a new base model
- [Tokenization & Embeddings](../tokenization_and_embeddings/tokenization_and_embeddings.md) — BPE vocabulary design decisions that precede any pre-training run
