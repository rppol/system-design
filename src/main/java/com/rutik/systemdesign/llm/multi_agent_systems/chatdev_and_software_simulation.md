...
**What is the "chat chain" in ChatDev and why is it the core coordination mechanism?**
...
**How does MetaGPT differ from ChatDev in its coordination approach?**
...
**What is hallucinated file content in the context of software simulation agents, and how do you detect it?**
...
**Why do software simulation agents use a shared code repository rather than passing full context between agents?**
...
**What are Standard Operating Procedures (SOPs) in MetaGPT and how do they reduce hallucination?**
...
**How does the QA repair loop work and what are the risks if it is not bounded?**
...
**What token costs should you expect for a simple CRUD REST API generated by ChatDev, and what drives cost higher?**
...
**How does role collapse occur in long-context software simulation agents, and how do you prevent it?**
...
**What is the difference between a two-agent dialogue in ChatDev and a pub-sub message bus in MetaGPT?**
...
**How do you handle the case where a generated file passes the programmer agent's QA phase but fails actual execution?**
...
**Why does MetaGPT's Project Manager agent exist as a separate role from the Architect?**
...
**What happens when the LLM produces JSON that doesn't conform to the expected schema in a MetaGPT pipeline?**
...
**How does the shared code repository prevent agents from working on stale file versions?**
...
**What is the executability rate reported in the ChatDev paper and what does it measure?**
...
**How would you adapt a ChatDev-style pipeline to operate on an existing codebase rather than generating from scratch?**
