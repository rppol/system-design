...
**What is the single most important thing to understand about CLIP — what can it do and what can it absolutely NOT do?**
...
**LLaVA and CLIP both use ViT encoders. Why can LLaVA answer spatial questions ("what's in the top-right corner?") while CLIP cannot?**
...
**Walk me through CLIP's InfoNCE contrastive loss. Why does a large batch size matter?**
...
**What is visual grounding and which models support it? Why don't standard VQA models support it natively?**
...
**How would you fine-tune LLaVA for a medical imaging use case? What do you freeze and why?**
...
**How does ViT patch embedding work for a 224x224 image with 16x16 patches? How many tokens does the LLM receive?**
...
**What VQA benchmarks matter and what do they actually measure?**
...
**What is the cost and latency comparison between CLIP and GPT-4V for classifying 10 million images per day?**
...
**What is SigLIP and why did Google develop it as an improvement over CLIP's training objective?**
...
**How does LLaVA-1.6 handle high-resolution images differently from LLaVA-1.5, and why does it matter?**
...
**What is the Q-Former in BLIP-2 and what problem does it solve?**
...
**When would you choose InternVL2 over LLaVA for production deployment?**
...
**What is Florence-2 and how does it differ architecturally from CLIP and LLaVA?**
...
**How does OCR capability emerge in VLMs and when should you use a dedicated OCR tool instead?**
...
**How do you handle multi-image inputs in GPT-4V, and what is the token cost?**
...
**What is the difference between image captioning and VQA architecturally, and why does VQA require instruction tuning?**
