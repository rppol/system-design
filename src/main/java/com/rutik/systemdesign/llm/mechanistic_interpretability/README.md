...
**1. A team reports "we trained a probe that detects deception with 95% accuracy in the model's activations — we've found the deception circuit." What's wrong with this claim?**
...
**2. Why can't you understand a large language model by reading what individual neurons respond to?**
...
**3. What is the linear representation hypothesis, and why does it matter practically?**
...
**4. What is a sparse autoencoder (SAE) and what specific problem does it solve?**
...
**5. Compare a vanilla L1-penalty SAE to a TopK SAE — what's the practical difference?**
...
**6. What is activation patching, and how is it different from simply ablating (zeroing) a component?**
...
**7. Walk through, at a high level, what the IOI circuit in GPT-2 small tells us, and why it's a landmark result.**
...
**8. When would you use attribution patching instead of full activation patching, and what's the catch?**
...
**9. What's the difference between logit lens and tuned lens, and why was tuned lens introduced?**
...
**10. How does CAA (Contrastive Activation Addition) steering work, and what happens if you push the coefficient too high?**
...
**11. What is ROME, what does it edit, and why does it break down when you try to edit thousands of facts — what does MEMIT change?**
...
**12. What is a cross-layer transcoder (CLT), and why did Anthropic move from per-layer SAEs to CLTs for circuit tracing?**
...
**13. If you train two SAEs with the same architecture and training data but different random seeds, will they discover "the same" features? What does the answer imply for using SAE features as a stable analysis tool?**
...
**14. How would you use mechanistic interpretability to investigate whether a model's chain-of-thought is "faithful" — i.e., whether its stated reasoning matches what it actually computed?**
...
**15. Your production support bot confidently states a made-up "return policy exception" for a product it has no real information about. How would you use mech interp techniques (beyond "add a disclaimer to the prompt") to find the root cause?**
...
**16. What's the practical cost breakdown of an SAE-based interpretability project — where does the time actually go?**
...
**17. What does "unexplained variance" mean in the context of an attribution graph, and why is it an important caveat to report?**
...
**18. What are the main limitations or criticisms of mechanistic interpretability as a field right now?**
