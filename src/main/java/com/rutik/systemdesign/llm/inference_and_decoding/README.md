...
<!-- study-paths
senior: README.md, kv_cache_optimization.md, speculative_decoding.md, sampling_and_decoding_strategies.md, constrained_decoding_and_structured_outputs.md
principal: README.md, kv_cache_optimization.md
