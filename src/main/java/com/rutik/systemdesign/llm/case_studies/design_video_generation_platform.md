...
**Why can video generation not be batched across jobs the way LLM inference batches requests?**
...
**How does temporal consistency get enforced at the model architecture level in DiT?**
...
**Why is async job submission mandatory for video generation, not just preferred?**
...
**What is the economic challenge that makes video generation harder to monetize than LLM serving?**
...
**How do you detect deepfakes in your own generated content without creating a recursive safety arms race?**
...
**Why does the CFG batching optimization save 30% latency rather than 50% (the theoretical maximum)?**
...
**How do you prevent PREMIUM queue starvation from FREE tier volume?**
...
**Why does DiT scale better than UNet for video generation at large model sizes?**
...
**What does FVD measure, and why is FID alone insufficient for video quality evaluation?**
...
**How do you handle a production model that generates temporally inconsistent outputs at the SSIM < 0.85 threshold?**
...
**What is the ethical concern with prompt caching in video generation, and how do you resolve it?**
