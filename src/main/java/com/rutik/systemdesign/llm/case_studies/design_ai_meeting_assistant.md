...
**Why does local-process beat bot-in-meeting for privacy, even though both use cloud LLMs?**
...
**How does the sliding-window Whisper approach avoid word-boundary artifacts?**
...
**Why does self-hosted STT cost 10,000x less than API at scale?**
...
**How does map-reduce handle a 2-hour meeting transcript?**
...
**How is GDPR consent compliance architected to withstand regulatory audit?**
...
**Why is speaker diarization harder in bot-in-meeting mode than local-process?**
...
**How do you handle bot join failure gracefully without the user losing their meeting?**
...
**What makes action item extraction harder than meeting summarization?**
...
**Why was Granola acquired for $100M given that it only works on macOS?**
...
**How do you measure STT quality in production without ground-truth transcripts?**
