...
**Why is self-hosted STT often required for HIPAA rather than using the OpenAI Whisper API?**
...
**How does speaker diarization determine which voice is the physician versus the patient?**
...
**Why is physician sign-off a legal requirement rather than just a UX feature?**
...
**How do you handle ICD-10 code hallucinations where the AI suggests a valid code that is clinically wrong?**
...
**What is the difference between FDA SaMD Class I, II, and III and which class does an AI medical scribe fall under?**
...
**How does FHIR R4 write-back work technically, and what authenticates the write?**
...
**What is the HIPAA minimum necessary principle and how does it shape the data architecture?**
...
**How do you evaluate transcription quality in a HIPAA environment without using real patient audio?**
...
**What happens when EHR write-back fails after the physician has already signed?**
...
**Why is per-encounter billing better than per-seat (physician) billing for hospital systems?**
...
**How would you handle a patient who speaks Spanish while their physician speaks English?**
