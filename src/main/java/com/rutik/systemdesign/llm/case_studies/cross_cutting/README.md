...
| [gpu_pool_economics.md](./gpu_pool_economics.md) | A100/H100/H200/B200 utilization math (MFU/MBU, dense vs sparsity FLOPS), spot/preemptible blending, cold-start optimization, prefill/decode disaggregation | gpu_inference_platform, chatgpt, copilot, video_generation, fine_tuning_platform |
