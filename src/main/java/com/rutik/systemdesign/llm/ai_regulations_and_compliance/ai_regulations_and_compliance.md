...
<!-- study-paths
principal: ai_regulations_and_compliance.md
...
**Q: What is the EU AI Act and which companies does it apply to?**
**Short:** The EU AI Act is a risk-tiered law binding on any provider or deployer whose AI system reaches the EU market, wherever they are headquartered.
...
**Q: Your company just deployed an AI hiring tool to EU customers without a conformity assessment. What is the legal exposure?**
**Short:** Deploying a high-risk hiring AI without a conformity assessment risks EU AI Act fines up to 3% of turnover plus a separate GDPR Art. 22 violation.
...
**Q: What does GDPR Article 22 require for automated decision-making, and what are the three permitted exceptions?**
**Short:** GDPR Art. 22 bars solely automated decisions with legal effects unless the subject consents, it is contract-necessary, or law authorizes it.
...
**Q: Does the EU AI Act apply to a US company with no EU offices?**
**Short:** Yes: EU AI Act Art. 2(1) covers a US company placing an AI system on the EU market even with zero EU establishment, mirroring GDPR.
...
**Q: What is a "high-risk AI system" under the EU AI Act? Name three examples.**
**Short:** High-risk AI systems are Annex III or II uses like hiring, credit scoring, or biometric identification requiring the Act's strict compliance regime.
...
**Q: What is a model card and when is it legally required?**
**Short:** A model card documents a model's intended use, data, performance, and limits, and the EU AI Act effectively mandates its content via Art. 11 technical docs.
...
**Q: How do you make a black-box model explainable for GDPR Art. 22 compliance?**
**Short:** SHAP computes each feature's marginal contribution to a prediction, letting a black-box model satisfy GDPR's "logic involved" disclosure requirement.
...
**Q: What is the difference between a GPAI model and a high-risk AI system under the EU AI Act?**
**Short:** A GPAI model is a broadly capable base model like GPT-4 or Claude, while a high-risk AI system is a specific Annex III or II deployment of any model.
...
**Q: How does the EU AI Act treat open-source AI models differently?**
**Short:** Open-source GPAI models under 10^25 FLOPs get reduced EU AI Act obligations, but systemic-risk open-source models above that threshold get no exemption.
...
**Q: What are the prohibited AI practices under the EU AI Act?**
**Short:** The EU AI Act bans six practices outright, including subliminal manipulation and real-time public biometric ID, with fines up to 7% of turnover.
...
**Q: What is a DPIA and when is one required for an AI system?**
**Short:** A DPIA is a GDPR Art. 35 assessment of an AI system's impact on individuals, mandatory before deployment for high-risk or large-scale profiling.
...
**Q: What is algorithmic bias and what are your legal obligations when you detect it post-deployment?**
**Short:** Detecting bias post-deployment can force pausing an EU AI Act high-risk system for re-assessment and can trigger GDPR Art. 22 and US Title VII exposure.
...
**Q: What are the technical logging requirements for EU AI Act high-risk systems?**
**Short:** EU AI Act Art. 12 mandates tamper-resistant logging of every high-risk system input, output, and model version, retained 6 months to 10 years.
...
**Q: How do you handle subject access requests for models trained on personal data?**
**Short:** GDPR Art. 15 subject access requests over training data require a data lineage registry linking records to individuals so requests can be answered.
...
**Q: What is the NIST AI RMF and what are its four core functions?**
**Short:** NIST AI RMF's four functions are Govern, Map, Measure, and Manage, forming a voluntary but increasingly de facto US AI risk framework.
...
**Q: What are the fines for violating the EU AI Act, and how do they stack with GDPR fines?**
**Short:** EU AI Act fines reach 7% of turnover for prohibited practices and stack separately from GDPR's up-to-4%-of-turnover Art. 83 penalties.
...
**Q: How does the US Executive Order on AI (EO 14110) differ from the EU AI Act in approach?**
**Short:** The EU AI Act is binding, risk-tiered legislation, while the US executive order coordinated federal agencies through existing authority instead of new penalties.
...
**Q: What is a conformity assessment and who can conduct it for EU AI Act high-risk systems?**
**Short:** A conformity assessment verifies EU AI Act compliance before deployment; most high-risk systems self-assess, but biometric systems need a notified body.
