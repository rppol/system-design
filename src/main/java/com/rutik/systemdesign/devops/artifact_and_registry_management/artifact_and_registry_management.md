...
- **Harbor with cosign + Trivy**: self-hosted registries scan on push and store signatures, and clusters admit only signed, scan-clean images (Connaisseur/Kyverno verify-images) — see [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md).
...
3. How would signing (cosign) + admission verification extend this into a full supply-chain guarantee (see [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md))?

---

**Cross-references:** [ci_cd_fundamentals](../ci_cd_fundamentals/ci_cd_fundamentals.md) (build once, promote the artifact), [containers_and_docker](../containers_and_docker/containers_and_docker.md) (image digests/layers), [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md) (scanning, signing, SBOM, admission), [helm_and_package_management](../helm_and_package_management/helm_and_package_management.md) (charts as OCI artifacts), [infrastructure_as_code_terraform](../infrastructure_as_code_terraform/infrastructure_as_code_terraform.md) (provisioning registries as code).
