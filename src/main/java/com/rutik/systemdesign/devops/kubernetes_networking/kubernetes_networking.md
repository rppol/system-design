...
<!-- study-paths
senior: kubernetes_networking.md
...
> Operational networking primitives (DNS, CIDR, LB types, TLS) are in [networking_for_devops](../networking_for_devops/networking_for_devops.md). Service mesh internals are in [`../../backend/service_mesh_and_service_discovery`](../../backend/service_mesh_and_service_discovery/service_mesh_and_service_discovery.md). This module is the Kubernetes-specific dataplane.
...
**Cross-references:** [networking_for_devops](../networking_for_devops/networking_for_devops.md) (DNS, CIDR, LB, TLS fundamentals), [kubernetes_workloads_and_objects](../kubernetes_workloads_and_objects/kubernetes_workloads_and_objects.md) (Services, Ingress, readiness→endpoints), [kubernetes_security](../kubernetes_security/kubernetes_security.md) (NetworkPolicy as zero-trust), [`../../backend/service_mesh_and_service_discovery`](../../backend/service_mesh_and_service_discovery/service_mesh_and_service_discovery.md) (mesh internals), [`case_studies/cross_cutting/multi_cluster_networking.md`](../case_studies/cross_cutting/multi_cluster_networking.md).
