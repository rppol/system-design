...
This three-pillar pivot is the payoff of putting `trace_id` in logs (see [observability_logging](../observability_logging/observability_logging.md)) and exemplars on metrics (see [observability_metrics_prometheus](../observability_metrics_prometheus/observability_metrics_prometheus.md)).
...
**Cross-references:** [observability_metrics_prometheus](../observability_metrics_prometheus/observability_metrics_prometheus.md) (RED metrics, exemplars linking metrics→traces), [observability_logging](../observability_logging/observability_logging.md) (correlate via `trace_id`; where high-cardinality detail lives), [visualization_and_alerting](../visualization_and_alerting/visualization_and_alerting.md) (Grafana trace/metric/log correlation UI), [service mesh — ../../backend/service_mesh_and_service_discovery](../../backend/service_mesh_and_service_discovery/service_mesh_and_service_discovery.md) (sidecars can auto-generate spans), [../../backend/observability_and_monitoring](../../backend/observability_and_monitoring/observability_and_monitoring.md) (application instrumentation, SDK setup, manual spans — owned there), [microservices — ../../backend/microservices_fundamentals](../../backend/microservices_fundamentals/microservices_fundamentals.md) (the fan-out tracing illuminates).
