...
**Cross-references:** [linux_and_os_fundamentals](../linux_and_os_fundamentals/linux_and_os_fundamentals.md) (signals, exec, exit codes), [ci_cd_fundamentals](../ci_cd_fundamentals/ci_cd_fundamentals.md) (scripts as pipeline steps), [`../../python/stdlib_datetime_and_logging`](../../python/stdlib_datetime_and_logging/stdlib_datetime_and_logging.md) (when to escalate to Python — `subprocess`, structured logging).
