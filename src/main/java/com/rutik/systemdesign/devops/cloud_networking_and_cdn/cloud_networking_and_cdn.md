...
Cloud networking layers on top of the single-VPC basics from [cloud_fundamentals_and_aws](../cloud_fundamentals_and_aws/cloud_fundamentals_and_aws.md) and the TCP/IP fundamentals in [networking_for_devops](../networking_for_devops/networking_for_devops.md).
...
**Cross-references:** [cloud_fundamentals_and_aws](../cloud_fundamentals_and_aws/cloud_fundamentals_and_aws.md) (VPC, subnets, ELB, Route 53 basics), [networking_for_devops](../networking_for_devops/networking_for_devops.md) (TCP/IP, DNS, BGP fundamentals), [gcp_and_azure_essentials](../gcp_and_azure_essentials/gcp_and_azure_essentials.md) (PSC, Virtual WAN, Front Door equivalents), [cloud_cost_optimization_finops](../cloud_cost_optimization_finops/cloud_cost_optimization_finops.md) (data-transfer/egress cost), [disaster_recovery_and_resilience](../disaster_recovery_and_resilience/disaster_recovery_and_resilience.md) (multi-Region failover), [serverless_and_faas](../serverless_and_faas/serverless_and_faas.md) (API Gateway/edge), [../../hld/](../../hld/README.md) (CDN and global load-balancing concepts).
