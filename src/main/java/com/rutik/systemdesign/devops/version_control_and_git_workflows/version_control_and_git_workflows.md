...
- **GitOps makes Git the deployment trigger** — a merge to `main` is what ships (see [gitops_argocd_flux](../gitops_argocd_flux/gitops_argocd_flux.md)).
...
2. How would a policy-as-code gate (see [policy_as_code_and_compliance](../policy_as_code_and_compliance/policy_as_code_and_compliance.md)) have blocked this PR pre-merge?
...
**Cross-references:** [gitops_argocd_flux](../gitops_argocd_flux/gitops_argocd_flux.md) (Git as deployment trigger), [ci_cd_fundamentals](../ci_cd_fundamentals/ci_cd_fundamentals.md) (commit → pipeline → artifact), [policy_as_code_and_compliance](../policy_as_code_and_compliance/policy_as_code_and_compliance.md) (pre-merge gates), [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md) (secret scanning, signed commits).
