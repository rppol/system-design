...
**Cross-references:** [kubernetes_workloads_and_objects](../kubernetes_workloads_and_objects/kubernetes_workloads_and_objects.md) (rolling update, readiness), [gitops_argocd_flux](../gitops_argocd_flux/gitops_argocd_flux.md) (Argo Rollouts under GitOps), [observability_metrics_prometheus](../observability_metrics_prometheus/observability_metrics_prometheus.md) (metrics that gate canaries), [sre_principles_and_slos](../sre_principles_and_slos/sre_principles_and_slos.md) (SLO-based release gates), [`../../database/database_migrations_zero_downtime`](../../database/database_migrations_zero_downtime/database_migrations_zero_downtime.md) (expand-contract).
