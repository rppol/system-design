...
The short window (5m/30m) makes the alert clear quickly once the burn stops; the long window (1h/6h) confirms the burn is real before paging. Burn-rate math lives in [sre_principles_and_slos](../sre_principles_and_slos/sre_principles_and_slos.md).
...
**Cross-references:** [observability_metrics_prometheus](../observability_metrics_prometheus/observability_metrics_prometheus.md) (the rules and PromQL behind alerts), [sre_principles_and_slos](../sre_principles_and_slos/sre_principles_and_slos.md) (SLOs and burn-rate math that drive symptom alerts), [incident_management_and_oncall](../incident_management_and_oncall/incident_management_and_oncall.md) (escalation policies, runbooks, what happens after a page fires), [observability_tracing_and_otel](../observability_tracing_and_otel/observability_tracing_and_otel.md) and [observability_logging](../observability_logging/observability_logging.md) (drill-down targets from dashboards), [gitops_argocd_flux](../gitops_argocd_flux/gitops_argocd_flux.md) (provisioning dashboards/alerts as code).
