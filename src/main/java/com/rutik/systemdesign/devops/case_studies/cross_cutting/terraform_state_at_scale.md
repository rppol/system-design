...
For backend syntax fundamentals and the resource graph model, see [`../../infrastructure_as_code_terraform/README.md`](../../infrastructure_as_code_terraform/infrastructure_as_code_terraform.md); for Terragrunt, OpenTofu state encryption, and Pulumi/Crossplane comparisons, see [`../../terraform_advanced_and_alternatives/README.md`](../../terraform_advanced_and_alternatives/terraform_advanced_and_alternatives.md).
