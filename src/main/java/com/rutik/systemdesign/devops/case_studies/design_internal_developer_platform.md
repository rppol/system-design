...
- The CI/CD execution engine internals (runners, caching) — the IDP *triggers* CI; see [`../gitops_argocd_flux/gitops_argocd_flux.md`](../gitops_argocd_flux/gitops_argocd_flux.md) for the delivery half.
