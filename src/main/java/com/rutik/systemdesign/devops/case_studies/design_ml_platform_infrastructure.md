...
**Why is GPU utilization the headline metric for an ML platform, and how do you actually raise it from 22% to 65%?**
...
**Walk me through what happens when a data scientist submits a 32-GPU distributed training job.**
...
**How do you provide multi-tenancy so 14 teams share GPUs without starving or crashing each other?**
...
**Why separate training and serving onto different node pools and pricing models?**
...
**How do you decide MIG vs time-slicing vs exclusive GPUs for a given workload?**
...
**What's your approach to cost on this platform, and how do you do chargeback?**
...
**How does scale-to-zero work and when should you NOT use it?**
...
**At what scale does the Kubernetes control plane become the bottleneck, and what do you do?**
...
**How do you handle a Spot interruption mid-training without losing the run?**
...
**Build vs buy — when would you NOT build this platform?**
...
**How do you keep GPUs from being starved by the data pipeline?**
...
**How do you safely roll out a new model version to a tier-1 endpoint?**
