...
This builds on [`../disaster_recovery_and_resilience/disaster_recovery_and_resilience.md`](../disaster_recovery_and_resilience/disaster_recovery_and_resilience.md) (DR strategy taxonomy) and [`../cloud_networking_and_cdn/cloud_networking_and_cdn.md`](../cloud_networking_and_cdn/cloud_networking_and_cdn.md) (DNS, anycast, global load balancing).
...
| Aurora instances | 3 × db.r6g.4xlarge (~$2,100/mo ea assumed, matching the migration case study) ≈ **$6,300/mo** | 2 × db.r6g.4xlarge (promotion-ready) ≈ **$4,200/mo** | Secondary readers sized = writer |
