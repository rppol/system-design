...
| k6 / Gatling | Load testing in pipeline (see [`../../backend/load_and_performance_testing`](../../backend/load_and_performance_testing/load_and_performance_testing.md)) |
...
3. Where would image signing + an admission gate (see [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md)) add another layer of "only this exact, scanned artifact runs in prod"?

---

**Cross-references:** [ci_cd_platforms](../ci_cd_platforms/ci_cd_platforms.md) (GitHub Actions/GitLab/Jenkins/Tekton), [deployment_strategies](../deployment_strategies/deployment_strategies.md) (canary/blue-green for the prod stage), [gitops_argocd_flux](../gitops_argocd_flux/gitops_argocd_flux.md) (pull-based CD), [artifact_and_registry_management](../artifact_and_registry_management/artifact_and_registry_management.md) (artifact storage/promotion), [version_control_and_git_workflows](../version_control_and_git_workflows/version_control_and_git_workflows.md) (commit → pipeline trigger), [devsecops_and_supply_chain_security](../devsecops_and_supply_chain_security/devsecops_and_supply_chain_security.md) (scan/sign in the pipeline).
