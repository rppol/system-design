...
# The technology bank and index moved to build_tech.py on 2026-07-31 -- this file builds
# the QUESTION bank and nothing else. in_tech_bank is imported because the Q&A walk below
# must skip the bank directory by exact path; the other two are called once each in main().
from build_tech import build_tech_bank, build_tech_index, in_tech_bank
