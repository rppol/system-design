...
**How does HNSW achieve sub-linear query time?**
...
**What is the recall-vs-speed tradeoff in ANN search?**
...
**What is hybrid search and when is it necessary?**
...
**How do embedding models affect retrieval quality in RAG systems?**
...
**What is product quantization and what is its recall-speed tradeoff?**
...
**How do you measure embedding quality and which metrics matter for RAG?**
...
**What is the "lost in the middle" problem for RAG and how does vector search help?**
...
**How does the IVFFlat index build and what happens when vectors are added after building?**
...
**What is the HNSW ef_construction parameter and how does it differ from ef at query time?**
...
**How does cosine similarity differ from dot product similarity for normalized vectors?**
