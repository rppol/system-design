...
**How does BM25 scoring work and when would you customize it?**
...
**What is the deep pagination problem in Elasticsearch and how do you solve it?**
...
**How do you change a field mapping without downtime using aliases?**
...
**What is a Lucene segment and why does force merge improve search performance?**
...
**Explain the near-real-time (NRT) search mechanism in Elasticsearch.**
...
**What is index lifecycle management (ILM) and how does it reduce costs?**
...
**How does Elasticsearch handle cluster state and shard allocation?**
...
**What are doc values and why do they matter for aggregations?**
...
**How do you diagnose why a search query is slow in Elasticsearch?**
...
**What is the difference between a nested object and a flattened object in Elasticsearch?**
...
**How do you scale Elasticsearch horizontally and what are the limits?**
