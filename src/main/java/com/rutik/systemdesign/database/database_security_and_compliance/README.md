...
**How does row-level security in PostgreSQL work and when would you use it?**
...
**What is the risk of granting SUPERUSER in PostgreSQL?**
...
**How do you implement the right to erasure without compromising referential integrity?**
...
**What is parameterized query and why does it prevent SQL injection?**
...
**How do you secure database credentials in a Kubernetes environment?**
...
**What is TDE (Transparent Data Encryption) and how does it compare to volume encryption?**
...
**How does pgAudit differ from PostgreSQL standard logging?**
...
**How do you detect and respond to SQL injection attacks?**
...
**What are the compliance database requirements for PCI DSS?**
...
**How do you implement column-level permissions for sensitive data?**
...
**What is the principle of least privilege and how do you audit compliance?**
...
**How do you protect against accidental data exposure via overly broad queries?**
