...
<!-- study-paths
senior: neural_network_fundamentals.md
...
## See Also
- [Foundations & Architecture (LLM)](../../llm/foundations_and_architecture/foundations_and_architecture.md) — how transformers build on MLP theory; self-attention, scaling laws, GPT vs BERT
