...
**Is k-means a special case of a GMM?**
...
**What is a responsibility in EM?**
...
**Walk through the E-step and the M-step.**
...
**Why is EM's log-likelihood guaranteed never to decrease?**
...
**What is the singular covariance / degeneracy problem and how do you fix it?**
...
**What are the covariance types and their tradeoff?**
...
**What is the ELBO and how does EM relate to it?**
...
**How do you use a GMM for anomaly detection?**
...
**Why must the E-step use log-sum-exp?**
...
**How does a GMM relate to a VAE or variational EM?**
...
**Can a GMM overfit, and how do you control it?**
...
**What is the computational complexity of EM per iteration?**
...
**When would you prefer a GMM over a single multivariate Gaussian for density estimation?**
...
**Why does k-means struggle with clusters of different sizes or densities, and does a GMM fix it?**
