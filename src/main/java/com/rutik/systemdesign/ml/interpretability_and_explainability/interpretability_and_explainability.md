...
> [`../../llm/mechanistic_interpretability/README.md`](../../llm/mechanistic_interpretability/mechanistic_interpretability.md).
...
9. **Log explanations in production**: store per-prediction SHAP and monitor their distribution as an early drift signal ([`../monitoring_and_drift_detection/README.md`](../monitoring_and_drift_detection/monitoring_and_drift_detection.md)).
