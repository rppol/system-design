...
See also: [Model Evaluation & Selection](../model_evaluation_and_selection/model_evaluation_and_selection.md)
for cross-validation strategy and calibration mechanics in depth,
[Feature Engineering](../feature_engineering/feature_engineering.md) for encoding and
scaling techniques referenced here, and
[ML System Design](../ml_system_design/ml_system_design.md) for point-in-time-correct
...
See [Model Evaluation & Selection](../model_evaluation_and_selection/model_evaluation_and_selection.md)
for Platt scaling, isotonic regression, and the Brier score in depth, and
[Uncertainty Quantification & Conformal Prediction](../uncertainty_quantification_and_conformal_prediction/uncertainty_quantification_and_conformal_prediction.md)
...
[Anomaly Detection](../anomaly_detection/anomaly_detection.md) for the full treatment
...
[Model Evaluation & Selection](../model_evaluation_and_selection/model_evaluation_and_selection.md) ·
[Feature Engineering](../feature_engineering/feature_engineering.md) ·
[ML System Design](../ml_system_design/ml_system_design.md) ·
