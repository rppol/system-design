...
**Short:** Deviance is the per-sample negative log-likelihood equal to cross-entropy for binary classification, and sklearn renamed the option to loss="log_loss" after removing the confusing "deviance" name in version 1.3.
