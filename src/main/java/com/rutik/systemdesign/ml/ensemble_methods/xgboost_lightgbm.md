...
**Short:** LightGBM predicts faster than XGBoost via integer histogram-bin comparisons and cache-friendly column layout, while CatBoost's symmetric trees are fastest of all.
