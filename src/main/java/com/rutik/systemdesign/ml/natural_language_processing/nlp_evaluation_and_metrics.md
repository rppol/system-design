...
**CoNLL-2003 NER Benchmark:** The gold standard NER benchmark reports entity-level F1. Devlin et al. report 92.4 test F1 for BERT-base and 92.8 for BERT-large; later encoders push into the 93-94 range. A 1-2 point gap matters for production because each false negative entity is a missed extraction — in financial document processing with 100K entities/day, 2 points is 2,000 fewer missed entities.
