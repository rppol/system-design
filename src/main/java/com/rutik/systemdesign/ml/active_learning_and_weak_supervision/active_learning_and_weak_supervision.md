...
> [data_pipelines_and_processing](../data_pipelines_and_processing/data_pipelines_and_processing.md) for the data
> plumbing and [natural_language_processing](../natural_language_processing/natural_language_processing.md) for the
...
- [uncertainty_quantification_and_conformal_prediction](../uncertainty_quantification_and_conformal_prediction/uncertainty_quantification_and_conformal_prediction.md) — epistemic uncertainty is the acquisition signal
- [data_pipelines_and_processing](../data_pipelines_and_processing/data_pipelines_and_processing.md) — the data infrastructure behind labeling loops
- [natural_language_processing](../natural_language_processing/natural_language_processing.md) — NER/classification tasks these techniques bootstrap
