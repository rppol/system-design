...
**Q: What is an OEC and how do you choose one?**
...
**Q: What is the difference between a guardrail metric and a counter-metric?**
...
**Q: What is the novelty effect and how does it bias experiments?**
...
**Q: How do you handle network effects in an experiment?**
...
**Q: What metrics would you use to evaluate a recommendation system experiment?**
...
**Q: A product team wants to run an experiment to test if a new ML model improves "user satisfaction." How do you define and measure this?**
...
**Q: What is the 4/5ths rule applied to experimentation? (Trick question — clarify why.)**
