...
**Q: What is calibration and how does it differ from discrimination (AUC)?**
...
**Q: A churn model has AUC=0.88 but the marketing team says it's not useful. What do you investigate?**
...
**Q: Explain Expected Calibration Error (ECE) and what a good value looks like.**
...
**Q: How does class imbalance cause miscalibration?**
...
**Q: What is temperature scaling and when is it appropriate?**
...
**Q: How would you monitor calibration in production?**
...
**Q: What is the base-rate correction problem in calibration?**
...
**Q: A model is used for both ranking (show top-100 results) and probability estimation (set intervention budget). One model or two?**
...
**Q: How does calibration drift and how do you trigger a recalibration?**
...
**Q: How do you handle calibration for a multi-class classifier?**
...
**Q: What is the reliability diagram and how do you read it?**
...
**Q: In a credit scoring system, the default rate shifts from 3% to 5% due to economic conditions. What happens to calibration and what do you do?**
...
**Q: Why is the AUC-ROC a poor metric for calibrated systems?**
