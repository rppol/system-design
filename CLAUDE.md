...
| **Technologies** | Per-technology deep dives (Apache Airflow, NVIDIA Triton Inference Server) — 2 modules | [technologies/CLAUDE.md](src/main/java/com/rutik/systemdesign/technologies/CLAUDE.md) |
| **Book** | Chapter-by-chapter book summaries (book-faithful chapter template, not the 14-section module template; no line ceiling) — DDIA (Kleppmann): 12 chapters + preface; System Design Interview Vol 1 (Xu): 16 chapters; Vol 2 (Xu & Lam): 13 chapters; Designing ML Systems (Huyen): 11 chapters | [book/CLAUDE.md](src/main/java/com/rutik/systemdesign/book/CLAUDE.md) |
