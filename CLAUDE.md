...
| **LLM** | LLM engineering guide — 53 modules, 29 case studies, 74 deep-dive sub-files | [llm/CLAUDE.md](src/main/java/com/rutik/systemdesign/llm/CLAUDE.md) |
...
| **Technologies** | Per-technology deep dives (Apache Airflow, NVIDIA Triton Inference Server, Intel OpenVINO) — 3 modules | [technologies/CLAUDE.md](src/main/java/com/rutik/systemdesign/technologies/CLAUDE.md) |
